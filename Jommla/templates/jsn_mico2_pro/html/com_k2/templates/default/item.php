...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>"> 
	...
	<div class="itemHeader">
		...
		<div class="jsn-article-toolbar">
			...
			<div class="itemToolbar k2ItemToolbar pull-right">
			...
			<div class="jsn-article-info">
				...
				<!-- Item Author -->
				<div class="author"> <span class="itemAuthor"> <?php echo K2HelperUtilities::writtenBy($this->item->author->profile->gender); ?>&nbsp;
				...
				<!-- Item Created Date -->
				<div class="createdate"> <span class="itemDateCreated"> <?php echo JHTML::_('date', $this->item->created , JText::_('K2_DATE_FORMAT_LC2')); ?> </span> </div>
				<?php endif; ?>
			</div>
		</div>
		<div class="clr"></div>
	...
	<div class="itemLinks k2ItemLinks">
		<?php if($this->item->params->get('itemHits')): ?>
		<!-- Item Hits --> 
