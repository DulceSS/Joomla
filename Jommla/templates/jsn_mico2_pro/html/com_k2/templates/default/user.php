			...
			<div class="userItemHeader">
			  ...
			  <h3 class="userItemTitle">
				...
				<div class="jsn-article-toolbar">
					...
					<!-- RSS feed icon -->
					<div class="userItemToolbar pull-right">
					...
					<div class="jsn-article-info">
						...
						<i class="fa fa-calendar"></i><span class="userItemDateCreated"><?php echo JHTML::_('date', $item->created , JText::_('K2_DATE_FORMAT_LC2')); ?></span>
						</span>
					</div>
					<?php endif; ?>
				</div>
