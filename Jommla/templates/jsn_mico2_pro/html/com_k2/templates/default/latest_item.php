...
<div class="latestItemView span<?php echo round(12 / $this->params->get('latestItemsCols'));?>"> 
	...
	<!-- Date created --> 
	<div class="jsn-article-toolbar"><div class="jsn-article-info"><span class="createdate"><i class="fa fa-calendar"></i><span class="latestItemDateCreated"> <?php echo JHTML::_('date', $this->item->created , JText::_('K2_DATE_FORMAT_LC2')); ?> </span></span></div></div>
	<?php endif; ?>
	...
	<div class="latestItemLinks k2ItemLinks">
