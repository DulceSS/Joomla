	...
	<div class="tagItemList">
		...
		<div class="tagItemView">
			<div class="tagItemHeader">
				...
				<!-- Date created -->
				<div class="jsn-article-toolbar"><div class="jsn-article-info">
				<div class="createdate">
					<i class="fa fa-calendar"></i><span class="tagItemDateCreated"><?php echo JHTML::_('date', $item->created , JText::_('K2_DATE_FORMAT_LC2')); ?></span>
				</div>
				</div></div>
				<?php endif; ?>
			</div>
			...
			<!-- Item "read more..." link -->
			<div class="clr"></div>
			<div class="tagItemContentFooter k2ItemContentFooter"> <a class="k2ReadMore" href="<?php echo $item->link; ?>"> <?php echo JText::_('K2_READ_MORE'); ?> </a> </div>
			<?php endif; ?>
			<div class="clr"></div>
			<?php if($item->params->get('tagItemCategory')): ?>
			<!-- Item category name -->
			<div class="tagItemLinks k2ItemLinks">
