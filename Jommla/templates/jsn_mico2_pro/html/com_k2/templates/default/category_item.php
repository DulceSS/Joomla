...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>"> 
	...
	<div class="catItemHeader">
		...
		<div class="jsn-article-toolbar">
			...
			<!-- RSS feed icon -->
			<div class="catItemToolbar pull-right">
			...
			<div class="jsn-article-info">
				...
				<!-- Item Author -->
				<div class="author"><span class="catItemAuthor"> <i class="fa fa-user"></i><?php echo K2HelperUtilities::writtenBy($this->item->author->profile->gender); ?> <a rel="author" href="<?php echo $this->item->author->link; ?>"><?php echo $this->item->author->name; ?></a> </span></div>
				<?php endif; ?>
	...
	<div class="clr"></div>
	<div class="catItemContentFooter k2ItemContentFooter">
	...
	<div class="catItemLinks k2ItemLinks">
